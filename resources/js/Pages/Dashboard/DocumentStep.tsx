...
const DocumentStep = Controller(Properties, ({ dispatch, dispatching }: ControllerProperties): JSX.Element => {
            ...
            <form {...{ onSubmit }} className="w-auto bg-black bg-opacity-25">
                ...
                <div className="flex flex-col md:flex-row bg-white border-b">
                    <div className="w-full md:w-1/3 flex flex-col border-r pb-6">
                        ...
                        <div className='px-6 pr-4'>
                            <div className="mt-3">
                                <Field type="image" name="ccaa" label="Please upload your ACA or CCAA certificate" />
                            </div>
                            <div className="mt-3">
                                <Field type="date-of-birth" name="user.dob" label="Expiry date" />
                            </div>
                        </div>
                    </div>
                    <div className="w-full md:w-1/3 flex flex-col border-r">
                        ...
                        <div className='px-6 pr-4'>
                            <div className="mt-3">
                                <Field type="image" name="insurance" label="Please upload your current insurance certificate" />
                            </div>
                            <div className="mt-3">
                                <Field type="date-of-birth" name="user.dob" label="Expiry date" />
                            </div>
                    ...
                    <div className="w-full md:w-1/3 flex flex-col">
                        ...
                        <div className='px-6 pr-4'>
                            <div className="mt-3">
                                <Field type="image" name="certificate" label="Please upload your current qualification certificate" />
                            </div>
                            <div className="mt-3">
                                <button
                                    type="button"
                ...
                <div className="flex flex-row-reverse p-4 items-end gap-6 bg-white rounded-b">
                    <button className="bg-blue-500 py-2 w-32 text-white rounded">
                        <Link variant="standard" to="/billing-step">Save & next</Link>
                    </button>
                    <button className="text-blue-500 bg-blue-100 py-2 w-32 rounded">
