...
const BillingStep = Controller(Properties, ({ dispatch, dispatching }: ControllerProperties): JSX.Element => {
            ...
            <form {...{ onSubmit }} className="w-auto bg-black bg-opacity-25">
                ...
                <div className="flex flex-col md:flex-row bg-white border-b">
                    ...
                    <div className="w-full md:w-1/3 flex flex-col">
                        ...
                        <div className='px-6 pr-4'>
                            <div className="mt-3">
                                <Field type="image" name="id_front" label="Please upload the front your license (ID front)" />
                            </div>
                            <div className="mt-3">
                    ...
                    <div className="w-full md:w-1/3 flex flex-col">
                        ...
                        <div className='px-6 pr-4'>
                            <div className="mt-3">
                                <Field type="image" name="id_backend" label="Please upload the back your license (ID back)" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-row-reverse p-4 items-end gap-6 bg-white rounded-b">
                    <button className="bg-blue-500 py-2 w-32 text-white rounded">
                        <Link variant="standard" to="/availability-step">Save & next</Link>
                    </button>
