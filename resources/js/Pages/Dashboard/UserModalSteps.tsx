...
const UserModalSteps = Controller(Properties, ({ dispatch, dispatching }: ControllerProperties): JSX.Element => {
            ...
            <form {...{ onSubmit }} className="w-auto bg-black bg-opacity-25">
                    ...
                    <div className="w-full md:w-1/3 flex flex-col border-r pb-6">
                        ...
                        <div className='px-6 pr-4'>
                            ...
                            <div className="mt-3">
                                ...
                                <button
                                    type="button"
                                    className="border-gray-300 border-2 w-full h-9 rounded p-1 mt-1 bg-white"
                                >
                                    Facebook
                                </button>
                                ...
                                <button
                                    type="button"
                                    className="border-gray-300 border-2 w-full h-9 rounded p-1 mt-3 bg-white"
                                >
                                    Linkedin
                                </button>
                ...
                <div className="flex flex-row-reverse p-4 items-end gap-6 bg-white rounded-b">
                    <button className="bg-blue-500 py-2 w-32 text-white rounded">
                        <Link variant="standard" to="/document-step">Save & next</Link>
                    </button>
