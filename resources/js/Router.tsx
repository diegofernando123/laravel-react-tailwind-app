...
import UserModalSteps from './Pages/Dashboard/UserModalSteps';
import DocumentStep from './Pages/Dashboard/DocumentStep';
import BillingStep from './Pages/Dashboard/BillingStep';
import AvailabilityStep from './Pages/Dashboard/AvailabilityStep';
import DoneStep from './Pages/Dashboard/DoneStep';
...
import UserWorkflow from './Pages/Users/Workflow';
        ...
        <>
            <Routes location={from || location}>
                ...
                <Route path="/" element={<Admin />}>
                    <Route path="modal-step" element={<UserModalSteps />} />
                    <Route path="document-step" element={<DocumentStep />} />
                    <Route path="billing-step" element={<BillingStep />} />
                    <Route path="availability-step" element={<AvailabilityStep />} />
